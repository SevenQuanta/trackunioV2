...
// it is to noise. 
#define APRS_COMMENT    "Weather balloon tracking - test packet."
...
// debug data will be printed out the Serial3 port.
...
//
// Particularly the DEBUG_AFSK will print every PWM sample out the Serial3
...
//
// 2. On the Serial3 monitor, set the baudrate to GPS_BAUDRATE (above),
//    usually 9600.
//
